...
public class IntegracionJpaTest {
    ...
    void testFindByPersonaThrowException() {
        Optional<Cuenta> cuenta = cuentaRepository.findByPersona("Leonel");
    ...
    void testSave() {
        //Given
        Cuenta cuentaPepe = new Cuenta(null, "Pepe", new BigDecimal("3000.00"));
...
//        Cuenta cuenta = cuentaRepository.findById(save.getId()).orElseThrow();
        ...
        assertEquals("3000.00", cuenta.getSaldo().toPlainString());
...
//        assertEquals(3, cuenta.getId());
        ...
        //When
        cuenta.setSaldo(new BigDecimal("3800.00"));
